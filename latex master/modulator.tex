...
\input{"../Task 1/latex/T1.tex"}

\newpage
\Hide
\chapter{Task 2}

\input{"../Task 2/latex/T2.tex"}
%--------------------------------Begin References--------------------------------%
...
\bibliography{modular}{bibliography}
\nocite{*}
%--------------------------------Begin Appendix--------------------------------%
